...
# ///
"""
Nghệ CLI - Skills Management Tool for Software Development

Usage:
    uvx nghe-cli.py init <project-name>
    uvx nghe-cli.py init .
    uvx nghe-cli.py init --here

Or install globally:
    uv tool install --from nghe-cli.py nghe-cli
    nghe init <project-name>
    nghe init .
    nghe init --here
"""
