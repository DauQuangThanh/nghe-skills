"""UI components and interactive elements for Nghệ CLI."""
...
app = typer.Typer(
    name="nghe",
    help="Skills management tool for Agentic AI development",
...
def callback(ctx: typer.Context):
    ...
    if ctx.invoked_subcommand is None and "--help" not in sys.argv and "-h" not in sys.argv:
        show_banner()
        console.print(Align.center("[dim]Run 'nghe --help' for usage information[/dim]"))
        console.print()
